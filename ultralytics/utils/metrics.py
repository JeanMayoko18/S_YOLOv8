...
def bbox_best_m(box1, box2, xywh=True, GIoU=False, WiseIoU= False, DIoU=False, CIoU=False, WIoU=False, eps=1e-7):
    """
    ...
    if GIoU:
       giou = getattr(IoU_Cal, GIoU)(b1, b2, self=self)
       results.append(giou)  # GIoU

    elif CIoU:
        ciou = getattr(IoU_Cal, CIoU)(b1, b2, self=self)
        results.append(ciou)  # CIoU

    elif DIoU:
        diou = getattr(IoU_Cal, DIoU)(b1, b2, self=self)
        results.append(diou)  # DIoU
        
    elif WiseIoU:
        Wiseiou = getattr(IoU_Cal, WiseIoU)(b1, b2, self=self)
        results.append(Wiseiou)  # Wise IoU  
    
    elif WIoU:
        Wiou = getattr(IoU_Cal, WIoU)(b1, b2, self=self)
        results.append(Wiou)  # WIoU  
    ...
    if len(results) == 1:
        ...
        if WiseIoU: metrics['Wiseiou'] = Wiseiou  
