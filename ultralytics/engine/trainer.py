...
from ultralytics.utils import (DEFAULT_CFG, LOGGER, RANK, SETTINGS, TQDM, __version__, callbacks, clean_url, colorstr, emojis,
                               yaml_save)
...
class BaseTrainer:
    ...
    def build_optimizer(self, model, name='auto', lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        ...
        if name == 'auto':
            ...
            name, lr, momentum = ('Adam', 0.01, 0.9) if iterations > 10000 else ('AdamW', lr_fit, 0.9)
            name, lr, momentum = ('SGD', 0.01, 0.9)
            LOGGER.info(f"{colorstr('lr determinated ')} is = {lr} ")
